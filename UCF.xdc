...
# Banck 15 : 1.8 v   ,   Banck 14 : 3.3 v    ,    Bancj 34 ; 1.8 v



# Clock_______________________________________________________________ 
...
#   Input Port_________________________________________________________
set_property -dict { PACKAGE_PIN A5   IOSTANDARD LVCMOS18 } [get_ports { Input_Signal[0] }]; 
set_property -dict { PACKAGE_PIN B6   IOSTANDARD LVCMOS18 } [get_ports { Input_Signal[01] }];
set_property -dict { PACKAGE_PIN A6   IOSTANDARD LVCMOS18 } [get_ports { Input_Signal[02] }];
set_property -dict { PACKAGE_PIN A7   IOSTANDARD LVCMOS18 } [get_ports { Input_Signal[03] }]; 
set_property -dict { PACKAGE_PIN C8   IOSTANDARD LVCMOS18 } [get_ports { Input_Signal[04] }]; 
set_property -dict { PACKAGE_PIN A8   IOSTANDARD LVCMOS18 } [get_ports { Input_Signal[05] }]; 
set_property -dict { PACKAGE_PIN C9   IOSTANDARD LVCMOS18 } [get_ports { Input_Signal[06] }]; 
set_property -dict { PACKAGE_PIN B9   IOSTANDARD LVCMOS18 } [get_ports { Input_Signal[07] }]; 
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS18 } [get_ports { Input_Signal[08] }]; 
set_property -dict { PACKAGE_PIN B10  IOSTANDARD LVCMOS18 } [get_ports { Input_Signal[09] }]; 
...
# Output Port_________________________________________________________
set_property -dict { PACKAGE_PIN M13  IOSTANDARD LVCMOSS33 } [get_ports { Output_Signal[0] }];
set_property -dict { PACKAGE_PIN N14  IOSTANDARD LVCMOSS33 } [get_ports { Output_Signal[1] }];
set_property -dict { PACKAGE_PIN N15  IOSTANDARD LVCMOSS33 } [get_ports { Output_Signal[2] }];
set_property -dict { PACKAGE_PIN P15  IOSTANDARD LVCMOSS33 } [get_ports { Output_Signal[3] }];
set_property -dict { PACKAGE_PIN P14  IOSTANDARD LVCMOSS33 } [get_ports { Output_Signal[4] }];
set_property -dict { PACKAGE_PIN R14  IOSTANDARD LVCMOSS33 } [get_ports { Output_Signal[5] }];
set_property -dict { PACKAGE_PIN N13  IOSTANDARD LVCMOSS33 } [get_ports { Output_Signal[6] }];
set_property -dict { PACKAGE_PIN L13  IOSTANDARD LVCMOSS33 } [get_ports { Output_Signal[7] }];
set_property -dict { PACKAGE_PIN N12  IOSTANDARD LVCMOSS33 } [get_ports { Output_Signal[8] }];
set_property -dict { PACKAGE_PIN L12  IOSTANDARD LVCMOSS33 } [get_ports { Output_Signal[9] }];
set_property -dict { PACKAGE_PIN N11  IOSTANDARD LVCMOSS33 } [get_ports { Output_Signal[10] }]; 


set_property -dict { PACKAGE_PIN L10  IOSTANDARD LVCMOSS33 } [get_ports { Output_Signal[11] }]; 
set_property -dict { PACKAGE_PIN R13  IOSTANDARD LVCMOSS33 } [get_ports { Output_Signal[12] }]; 
set_property -dict { PACKAGE_PIN P12  IOSTANDARD LVCMOSS33 } [get_ports { Output_Signal[13] }]; 
set_property -dict { PACKAGE_PIN R12  IOSTANDARD LVCMOSS33 } [get_ports { Output_Signal[14] }]; 
set_property -dict { PACKAGE_PIN P11  IOSTANDARD LVCMOSS33 } [get_ports { Output_Signal[15] }]; 
set_property -dict { PACKAGE_PIN R11  IOSTANDARD LVCMOSS33 } [get_ports { Output_Signal[16] }]; 
set_property -dict { PACKAGE_PIN P10  IOSTANDARD LVCMOSS33 } [get_ports { Output_Signal[17] }]; 
set_property -dict { PACKAGE_PIN P1   IOSTANDARD LVCMOSS33 } [get_ports { Output_Signal[18] }]; 
set_property -dict { PACKAGE_PIN R2   IOSTANDARD LVCMOSS33 } [get_ports { Output_Signal[19] }]; 
set_property -dict { PACKAGE_PIN R3   IOSTANDARD LVCMOSS33 } [get_ports { Output_Signal[20] }]; 



set_property -dict { PACKAGE_PIN R4   IOSTANDARD LVCMOSS33 } [get_ports { Output_Signal[21] }]; 
set_property -dict { PACKAGE_PIN N6   IOSTANDARD LVCMOSS33 } [get_ports { Output_Signal[22] }]; 
set_property -dict { PACKAGE_PIN M7   IOSTANDARD LVCMOSS33 } [get_ports { Output_Signal[23] }]; 
set_property -dict { PACKAGE_PIN M8   IOSTANDARD LVCMOSS33 } [get_ports { Output_Signal[24] }]; 
set_property -dict { PACKAGE_PIN N7   IOSTANDARD LVCMOSS33 } [get_ports { Output_Signal[25] }]; 
set_property -dict { PACKAGE_PIN N8   IOSTANDARD LVCMOSS33 } [get_ports { Output_Signal[26] }]; 
set_property -dict { PACKAGE_PIN N9   IOSTANDARD LVCMOSS33 } [get_ports { Output_Signal[27] }]; 
set_property -dict { PACKAGE_PIN R9   IOSTANDARD LVCMOSS33 } [get_ports { Output_Signal[28] }]; 
set_property -dict { PACKAGE_PIN R10  IOSTANDARD LVCMOSS33 } [get_ports { Output_Signal[29] }]; 
set_property -dict { PACKAGE_PIN M10  IOSTANDARD LVCMOSS33 } [get_ports { Output_Signal[30] }]; 


set_property -dict { PACKAGE_PIN N10  IOSTANDARD LVCMOSS33 } [get_ports { Output_Signal[31] }]; 
set_property -dict { PACKAGE_PIN R7   IOSTANDARD LVCMOSS33 } [get_ports { Output_Signal[32] }]; 
set_property -dict { PACKAGE_PIN R8   IOSTANDARD LVCMOSS33 } [get_ports { Output_Signal[33] }]; 



#   ID__________________________________________________________________

set_property -dict { PACKAGE_PIN C6   IOSTANDARD LVCMOSS33 } [get_ports { Output_Signal[0] }]; 
set_property -dict { PACKAGE_PIN C7   IOSTANDARD LVCMOSS33 } [get_ports { Output_Signal[1] }]; 
set_property -dict { PACKAGE_PIN D7   IOSTANDARD LVCMOSS33 } [get_ports { Output_Signal[2] }]; 
set_property -dict { PACKAGE_PIN D8   IOSTANDARD LVCMOSS33 } [get_ports { Output_Signal[3] }]; 
set_property -dict { PACKAGE_PIN D9   IOSTANDARD LVCMOSS33 } [get_ports { Output_Signal[4] }]; 
...
#   AD7490(16Channel,1MSPS,12bit) ________________________________
...
#   Rs485_________________________________________________________
...
#   Flash_____________________________________________________
